<?php 
    ...
    function csScripts(){
        ...
        if(strstr($_SERVER['SERVER_NAME'], 'constructionsite.local')){
            ...
            wp_enqueue_script('cs__main-js', get_theme_file_uri('/bundled-assets/scripts.26fe109084f7e8f46406.js'), NULL, '1.0', true);
            wp_enqueue_style('cs__main-styles', get_theme_file_uri('/bundled-assets/styles.26fe109084f7e8f46406.css'));
        }
    }
